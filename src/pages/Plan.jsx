          ...
          >
            ...
            >
              ...
              <Box sx={{ textAlign: "center", mb: 4 }}>
                ...
                >
                  Share your dates, dream wildlife sightings and budget. We'll
                  hand-craft an expert-guided, crowd-free itinerary across East
                  Africa's best parks and beaches. Ready for the Great
                  Migration, gorilla treks or Zanzibar's white sand? Let's build
                  your unforgettable journey today.
                </Typography>
              </Box>
                          ...
                          <FormControlLabel
                            control={
                              <Checkbox
                                required={currentField.is_required}
                                checked={
                                  formData[currentField.field_name] || false
                                }
                                onChange={(e) =>
                                  handleInputChange(
                                    currentField.field_name,
                                ...
                                <FormControlLabel
                                  ...
                                  control={
                                    <Checkbox
                                      ...
                                      onChange={(e) => {
                                        const currentValues =
                                          formData[currentField.field_name] ||
                                          [];
                                        let newValues;
                                        if (e.target.checked) {
                                          newValues = [
                  ...
                  <Box sx={{ maxWidth: 800, mx: "auto" }}>
                    ...
                    <Box sx={{ mb: 3 }}>
                      <FormControlLabel
                        ...
                        label="Yes, send me Akira Safaris' newsletter. You can unsubscribe at any time. See our Privacy Policy."
                        sx={{
                    ...
                    >
                      ...
                      >
                        ...
                        Policy and Notice at Collection. You may opt out of our
              ...
              >
                ...
                {isLastStep ? (
                  ...
                  >
                    {loading
                      ? "Submitting..."
                      : currentForm.submit_button_text || "Submit Form"}
                  </Button>
                ) : (
                  <Button
                    variant="contained"
        ...
        >
          ...
          >
            ...
            <Box sx={{ textAlign: "center", mb: 4 }}>
              ...
              >
                Fill out our safari planning form to get started on your
                adventure
              </Typography>
            </Box>
