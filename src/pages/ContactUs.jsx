  ...
  return (
    <Box
      ...
      sx={{
        ...
        pb: { xs: 1.5, sm: 1.5, md: 1.5 },
        px: 0,
        background: "#FFFFFF",
      }}
    >
      <Helmet>
        <title>Contact Akira Safaris | Book a Kenya Safari</title>
        <meta
          name="description"
          content="Contact Akira Safaris to plan a Kenya or East Africa safari. Reach us by phone or email and start crafting your adventure."
        />
      </Helmet>
      <Card
        sx={{
